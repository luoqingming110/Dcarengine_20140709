...
{
    public partial class 测试日期 : EASkins.Controls.MaterialForm
    {
        private static String address = "028D55";
        ...
        private void ami_Button_22_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //String stafinal = "";
                //final
                EolFunction.writeFunction(address, length, text.PadLeft(6,'0'), CommonCmd._808102);
